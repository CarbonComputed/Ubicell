...
def fetch_url(url, referer = None, retries = 1, dimension = False,useragent=False):
    cur_try = 0
...
class GootubeScraper(MediaScraper):
    ...
    def largest_image_url(self):
        ...
        if m:
            ...
            image_url = funcs.safe_eval_str(image_url)
            return image_url
